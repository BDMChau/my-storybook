...
Demo.args = {
  ...
  onClickCard: (values) => console.log('values', values),
  onClickTab: (values) => console.log('values', values),
  onClickMenu: (values) => console.log('values', values),
  onClickSchedule: (values) => console.log('values', values),
  data: {
    assigned: [
      {
        title: 'Assigned 1',
        ...
        data: [
          {
            id: 2,
            title:
              'Study for abcdqweiruehgldfjknghlkfhjngfloi dfsgljhrteuiohguioert geroigjeriogjer erlogiwerjiogeroig weoirh8w37qeuju2193erui430ifgtj weio0prjuf34890gjforiekgjnm fwo4hjgt98345hjtg89345noeigh',
            subTitle:
